...
TWEAK_NAME = bulletforcenewesptest

bulletforcenewesptest_CFLAGS = -fobjc-arc
bulletforcenewesptest_CCFLAGS = -std=c++11 -fno-rtti -fno-exceptions -DNDEBUG

ifeq ($(IGNORE_WARNINGS),1)
  bulletforcenewesptest_CFLAGS += -w
  bulletforcenewesptest_CCFLAGS += -w
endif


bulletforcenewesptest_FILES =  esp.mm Tweak.xm $(MENU_SRC) $(KITTYMEMORY_SRC) $(SCLALERTVIEW_SRC)

bulletforcenewesptest_LIBRARIES += substrate
